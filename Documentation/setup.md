...
- This has been tested with Daml SDK 2.6.0 and Daml Community and Enterprise 2.6.0
...
- Community - https://github.com/digital-asset/daml and download canton-community-2.6.0.tar.gz
...
```~/src/canton-enterprise-2.6.0``` then "```export
CANTON_DIR=~/src/canton-enterprise-2.6.0```".
