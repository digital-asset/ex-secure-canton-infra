...
$CANTON_DIR/bin/canton $RUN_AS_DAEMON --log-file-name log/mediator2.log -c configs/mixins/api/public.conf -c configs/mixins/api/public-admin.conf -c configs/mixins/parameters/nonuck.conf -c configs/mixins/storage/postgres.conf -c configs/domain/mediator2.conf
