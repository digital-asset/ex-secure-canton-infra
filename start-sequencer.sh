...
echo "Using Sequencer 1 Port: $CANTON_SEQUENCER_1_PUBLIC_PORT"

$CANTON_DIR/bin/canton $RUN_AS_DAEMON --log-file-name log/sequencer.log -c configs/mixins/api/public.conf -c configs/mixins/api/public-admin.conf -c configs/mixins/parameters/nonuck.conf -c configs/mixins/storage/postgres.conf -c configs/domain/sequencer.conf
